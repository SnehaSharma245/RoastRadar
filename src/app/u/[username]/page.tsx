...
import { Loader, Flame, Send, Lightbulb, Target } from "lucide-react";
...
function Page() {
  ...
  const fetchSuggestions = async () => {
    ...
    try {
      ...
      toast({
        title: "Failed to fetch roast suggestions",
  ...
  const onSubmit = async (data: z.infer<typeof messageSchema>) => {
    try {
      ...
      toast({
        ...
        description: "Your savage message has been sent anonymously!",
        duration: 2000,
      });
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-4">
            <Flame className="w-10 h-10 text-purple-600 mr-3" />
            <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-purple-600 via-violet-600 to-purple-800 bg-clip-text text-transparent">
              RoastFlex
            </h1>
            <Flame className="w-10 h-10 text-purple-600 ml-3" />
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border-2 border-purple-200 p-6 mb-6">
            ...
            <p className="text-purple-700 text-lg">
              Time to deliver some anonymous fire! 🌶️ What savage feedback do
              you have?
            </p>
          </div>
        </div>
        ...
        <div className="text-center mt-8">
          <div className="bg-purple-100 border-2 border-purple-200 rounded-2xl p-4">
            <p className="text-purple-700 text-sm">
              🔒 Your identity is completely anonymous. Roast responsibly and
              keep it fun!
            </p>
          </div>
        </div>
